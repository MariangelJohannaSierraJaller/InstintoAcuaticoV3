      ...
      <tbody>
        ...
        while ($results = $records->fetch(PDO::FETCH_ASSOC)) { ?>
          <tr>
            ...
            <td>
              <a href='modificar_instructores.php?id=<?php echo $results['id']; ?>'><button type='button' class="button4">Modificar</a>
              <a href="eliminar_instructores.php?id=<?php echo $results['id']; ?>"><button type='button' class="button2">Eliminar</a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
