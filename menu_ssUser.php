...
<?php include("assets/head/links.html") ?>
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <center><h2><?php echo $user['name']; ?>, estas son las solicitudes de servicio que hiciste.</h2><center>
        </div>
      </div>
    ...
    <table class="content-table">
      ...
      <tbody>
        <?php
        $records = $con->prepare( "select * from registros where email='".$user["email"]."'");
        ...
        while ($results = $records->fetch(PDO::FETCH_ASSOC)) { ?>
          <tr>
            ...
            <td>
              <a href='modificar_ssUser.php?id=<?php echo $results['id']; ?>'><button type='button' class="button4">Modificar</a>
